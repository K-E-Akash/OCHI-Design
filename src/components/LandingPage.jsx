                ...
                {['We Create', 'Eye-Opening', 'Presentations'].map((item, index) => (
                    <div className="masker flex ml-[4vw]">
                        <div className='pt-4'>
                            ...
                            className='bg-green-200 overflow-hidden w-[8.5vw] h-[11.5vh] mr-4 rounded' key={index}><img className='w-full h-full' src="src/public/images/bg.jpg" alt="" /></motion.div>)}
                        </div>
