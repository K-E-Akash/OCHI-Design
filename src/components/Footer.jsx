...
function Footer() {
	return (
		<>
			<div className="w-full h-[120vh] bg-zinc-700 px-[4vw] font-['Neue_Montreal'] text-zinc-100">
				<div className='w-full flex flex-row'>
					<div className="text-[8vw] left w-1/2 h-screen font-['Test_Founders_Grotesk_X_Condensed'] leading-[6.5vw] pt-[13vh]">
						EYE- <br />
						OPENING
					</div>
					<div className="right w-1/2 h-screen">
						<h1 className="font-['Test_Founders_Grotesk_X_Condensed'] text-[8vw] leading-[6.5vw] pt-[13vh]">PRESENTATIONS</h1>
						<div className='flex flex-row text-zinc-300'>
							<div className="rLeft">
								...
								<div className='footerLinkWrap'>
									<p>L:</p>
									{['202-1965 W 4th Ave Vancouver, Canada', '30 Chukarina StLviv, Ukraine'].map((e, i) => (
										<a className='underline w-[10vw]' key={i}>{e}</a>
									))}
								</div>
								<div className='footerLinkWrap'>
									<p>E:</p>
									<a className='underline w-min'>hello@ochi.design</a>
								</div>
							</div>
							<div className="rRight w-full flex justify-end items-end">
								<div className='footerLinkWrap'>
									<p>M:</p>
									{['Home', 'Services', 'Our work', 'About us', 'Insights', 'Contact us'].map((e, i) => (
										<a className='underline' key={i}>{e}</a>
									))}
								</div>
							</div>
						</div>
				...
				<div className='w-full h-[20vh] flex flex-row justify-between items-center text-zinc-500'>
					<svg className='text-zinc-100' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<p className='text-md pl-[19vw]'>© ochi design 2024. Legal Terms</p>
					<p className='text-md'>Website by Obys</p>
				</div>
			</div>
		</>
	)
